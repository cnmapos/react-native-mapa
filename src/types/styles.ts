...
type ExpressionField = string | number | boolean | Expression | ExpressionField[] | { [key: string]: ExpressionField };
...
export interface FillLayerStyleProps {
     ...
     */
    fillOpacity?: Value<number, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     */
    fillColor?: Value<string, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     * @disabledBy fillPattern
     */
    fillOutlineColor?: Value<string, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     */
    fillTranslateAnchor?: Value<Enum<FillTranslateAnchorEnum, FillTranslateAnchorEnumValues>, ['zoom']>;
    /**
...
export interface LineLayerStyleProps {
     ...
     */
    lineOpacity?: Value<number, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     */
    lineColor?: Value<string, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     */
    lineTranslateAnchor?: Value<Enum<LineTranslateAnchorEnum, LineTranslateAnchorEnumValues>, ['zoom']>;
    /**
     * Stroke thickness.
     */
    lineWidth?: Value<number, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     */
    lineGapWidth?: Value<number, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     */
    lineOffset?: Value<number, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     */
    lineBlur?: Value<number, ['zoom', 'feature', 'feature-state', 'measure-light']>;
...
export interface SymbolLayerStyleProps {
     ...
     */
    symbolPlacement?: Value<Enum<SymbolPlacementEnum, SymbolPlacementEnumValues>, ['zoom']>;
    /**
     ...
     * @requires iconImage
     */
    iconRotationAlignment?: Value<Enum<IconRotationAlignmentEnum, IconRotationAlignmentEnumValues>, ['zoom']>;
    /**
     ...
     * @requires iconImage, textField
     */
    iconTextFit?: Value<Enum<IconTextFitEnum, IconTextFitEnumValues>, ['zoom', 'feature']>;
    /**
     ...
     * @requires iconImage
     */
    iconAnchor?: Value<Enum<IconAnchorEnum, IconAnchorEnumValues>, ['zoom', 'feature']>;
    /**
     * Orientation of icon when map is pitched.
     *
     * @requires iconImage
     */
    iconPitchAlignment?: Value<Enum<IconPitchAlignmentEnum, IconPitchAlignmentEnumValues>, ['zoom']>;
    /**
     * Orientation of text when map is pitched.
     *
     * @requires textField
     */
    textPitchAlignment?: Value<Enum<TextPitchAlignmentEnum, TextPitchAlignmentEnumValues>, ['zoom']>;
    /**
     * In combination with `symbolPlacement`, determines the rotation behavior of the individual glyphs forming the text.
     *
     * @requires textField
     */
    textRotationAlignment?: Value<Enum<TextRotationAlignmentEnum, TextRotationAlignmentEnumValues>, ['zoom']>;
    /**
     ...
     * @requires textField
     */
    textJustify?: Value<Enum<TextJustifyEnum, TextJustifyEnumValues>, ['zoom', 'feature']>;
    /**
     ...
     * @requires textField
     */
    textVariableAnchor?: Value<Enum<TextVariableAnchorEnum, TextVariableAnchorEnumValues>[], ['zoom']>;
    /**
     ...
     */
    textAnchor?: Value<Enum<TextAnchorEnum, TextAnchorEnumValues>, ['zoom', 'feature']>;
    /**
     ...
     * @requires textField
     */
    textWritingMode?: Value<Enum<TextWritingModeEnum, TextWritingModeEnumValues>[], ['zoom']>;
    /**
     ...
     * @requires textField
     */
    textTransform?: Value<Enum<TextTransformEnum, TextTransformEnumValues>, ['zoom', 'feature']>;
    /**
     ...
     * @requires iconImage
     */
    iconOpacity?: Value<number, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     * @requires iconImage
     */
    iconColor?: Value<string, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     * @requires iconImage
     */
    iconHaloColor?: Value<string, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     * @requires iconImage
     */
    iconHaloWidth?: Value<number, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     * @requires iconImage
     */
    iconHaloBlur?: Value<number, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     */
    iconTranslateAnchor?: Value<Enum<IconTranslateAnchorEnum, IconTranslateAnchorEnumValues>, ['zoom']>;
    /**
     * The opacity at which the text will be drawn.
     *
     * @requires textField
     */
    textOpacity?: Value<number, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     * @requires textField
     */
    textColor?: Value<string, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     * @requires textField
     */
    textHaloColor?: Value<string, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     * @requires textField
     */
    textHaloWidth?: Value<number, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     * @requires textField
     */
    textHaloBlur?: Value<number, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     */
    textTranslateAnchor?: Value<Enum<TextTranslateAnchorEnum, TextTranslateAnchorEnumValues>, ['zoom']>;
    /**
     ...
     */
    iconImageCrossFade?: Value<number, ['zoom', 'feature', 'feature-state', 'measure-light']>;
...
export interface CircleLayerStyleProps {
     ...
     * Circle radius.
     */
    circleRadius?: Value<number, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     */
    circleColor?: Value<string, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     */
    circleBlur?: Value<number, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     */
    circleOpacity?: Value<number, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     */
    circleTranslateAnchor?: Value<Enum<CircleTranslateAnchorEnum, CircleTranslateAnchorEnumValues>, ['zoom']>;
    /**
     * Controls the scaling behavior of the circle when the map is pitched.
     */
    circlePitchScale?: Value<Enum<CirclePitchScaleEnum, CirclePitchScaleEnumValues>, ['zoom']>;
    /**
     * Orientation of circle when map is pitched.
     */
    circlePitchAlignment?: Value<Enum<CirclePitchAlignmentEnum, CirclePitchAlignmentEnumValues>, ['zoom']>;
    /**
     * The width of the circle's stroke. Strokes are placed outside of the `circleRadius`.
     */
    circleStrokeWidth?: Value<number, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     */
    circleStrokeColor?: Value<string, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     */
    circleStrokeOpacity?: Value<number, ['zoom', 'feature', 'feature-state', 'measure-light']>;
...
export interface HeatmapLayerStyleProps {
     ...
     */
    heatmapRadius?: Value<number, ['zoom', 'feature', 'feature-state', 'measure-light']>;
     ...
     */
    heatmapWeight?: Value<number, ['zoom', 'feature', 'feature-state', 'measure-light']>;
    /**
...
export interface FillExtrusionLayerStyleProps {
     ...
     */
    fillExtrusionColor?: Value<string, ['zoom', 'feature', 'feature-state', 'measure-light']>;
    ...
    fillExtrusionTranslateAnchor?: Value<
        Enum<FillExtrusionTranslateAnchorEnum, FillExtrusionTranslateAnchorEnumValues>,
        ['zoom']
    >;
    /**
     ...
     * @disabledBy fillExtrusionAmbientOcclusionIntensity
     */
    fillExtrusionFloodLightWallRadius?: Value<number, ['feature', 'feature-state']>;
     ...
     * @disabledBy fillExtrusionAmbientOcclusionIntensity
     */
    fillExtrusionFloodLightGroundRadius?: Value<number, ['feature', 'feature-state']>;
...
export interface RasterLayerStyleProps {
     ...
     */
    rasterResampling?: Value<Enum<RasterResamplingEnum, RasterResamplingEnumValues>, ['zoom']>;
    /**
...
export interface HillshadeLayerStyleProps {
    ...
    hillshadeIlluminationAnchor?: Value<
        Enum<HillshadeIlluminationAnchorEnum, HillshadeIlluminationAnchorEnumValues>,
        ['zoom']
    >;
    /**
...
export interface ModelLayerStyleProps {
     ...
     */
    modelColor?: Value<string, ['feature', 'feature-state', 'measure-light', 'zoom']>;
     ...
     */
    modelColorMixIntensity?: Value<number, ['feature', 'feature-state', 'measure-light']>;
     ...
     */
    modelEmissiveStrength?: Value<number, ['feature', 'feature-state', 'measure-light']>;
     ...
     */
    modelHeightBasedEmissiveStrengthMultiplier?: Value<number[], ['feature', 'feature-state', 'measure-light']>;
